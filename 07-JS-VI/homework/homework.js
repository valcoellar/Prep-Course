...
function sumarArray(numeros, cb) {
  ...
  //Tu código:
  Resultado=0;
  numeros.forEach(function (elemento,indice){Resultado += elemento}   );

 // asi se pasa el resultado 
  cb(Resultado);
}
...
array.forEach(function(elemento,indice){
    if (elemento[0] == "a"){NewArray.push(elemento)};
                                        });
return NewArray;
*/

var NewArray = array.filter(function(elemento){return elemento[0] == "a";})
return NewArray;
